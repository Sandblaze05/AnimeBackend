...
This API scrapes data from animetosho.org. The maintainer of this API is not responsible for the content of the search results. Web scraping is a fragile process. Website structure can change, which may break the scraper.
